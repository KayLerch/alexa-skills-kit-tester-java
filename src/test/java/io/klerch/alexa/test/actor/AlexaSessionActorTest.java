...
public class AlexaSessionActorTest {
    ...
    public void generateSessionId() throws Exception {
        final String sessionId = AlexaSessionActor.generateSessionId();
        Assert.assertNotNull(sessionId);
        Assert.assertTrue(sessionId.matches("SessionId.[a-z0-9-]{36}"));

        final String sessionId2 = AlexaSessionActor.generateSessionId();
